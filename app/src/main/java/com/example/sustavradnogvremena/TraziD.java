...
public class TraziD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trazi_d);

        String datum = getIntent().getStringExtra("Datum");

        TextView internet = (TextView) findViewById(R.id.internet_TraziD);
    ...
    public void Trazi(String datum){
        ListView list = (ListView) findViewById(R.id.listView_D);
        ...
        try {
            ...
            if(con!=null) {
                ...
                String query = "Select * from radno_vrijeme where datum = '" + datumProvjera + "' order by radno_vrijeme.datum desc";
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery(query);
