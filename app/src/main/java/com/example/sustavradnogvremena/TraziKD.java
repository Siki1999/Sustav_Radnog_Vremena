...
public class TraziKD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trazi_kd);

        String korisnik = getIntent().getStringExtra("Korisnik");
        String datum = getIntent().getStringExtra("Datum");

        TextView internet = (TextView) findViewById(R.id.internet_TraziKD);
        ...
        if(networkInfo!=null && networkInfo.isConnected()){
            ...
            Trazi(korisnik, datum, korisnickoime);
        }
        else{
    ...
    public void Trazi(String korisnik, String datum, String korisnickoime){
        ListView list = (ListView) findViewById(R.id.listView_KD);
        ...
        try {
            ...
            if(con!=null) {
                ...
                String query = "Select * from radno_vrijeme where datum = '" + datumProvjera + "' and korisnik_id = "
